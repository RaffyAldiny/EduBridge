            ...
            <div class="flex items-center justify-between py-4 border-b border-gray-700">
                <div class="flex items-center">
                    <div class="relative">
                        ...
                        <span
                            class="absolute bottom-0 right-0 block w-3 h-3 bg-green-500 rounded-full ring-2 ring-white"></span>
                    </div>
                    <div class="ml-4">
            ...
            <div class="flex items-center justify-between py-4 border-b border-gray-700">
                <div class="flex items-center">
                    <div class="relative">
                        <img src="https://via.placeholder.com/40" alt="Profile Picture" class="w-10 h-10 rounded-full">
                        <span
                            class="absolute bottom-0 right-0 block w-3 h-3 bg-red-500 rounded-full ring-2 ring-white"></span>
                    </div>
                    <div class="ml-4">
