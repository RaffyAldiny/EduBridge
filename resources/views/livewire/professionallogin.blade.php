...
<div x-show="showProfessionalModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50" x-data="{ isLogin: true, fileName: '' }">
    <div class="bg-maincolor pt-3 pb-1 pr-6 pl-6 rounded-[6px] shadow-lg w-[400px]">
        ...
        <form x-show="isLogin" class="space-y-1">
            ...
            <div class="flex justify-center gap-12 mt-6">
                ...
                <button type="button" @click="showProfessionalModal = false" class="bg-[#c4eaf7] text-hover text-[18px] h-[36px] font-bold border-hover border-[1px] px-1 py-1 rounded-[4px] w-[130px]">CANCEL</button>
            </div>
        </form>
        ...
        <form x-show="!isLogin" class="space-y-1">
            <!-- Last Name -->
            <div class="mb-3">
                <input type="text" class="text-hover mt-1 w-full px-2 py-[1px] border-[2px] border-hover rounded-[3px] placeholder-hover text-center" placeholder="Last Name">
            </div>

            <!-- Username (Email) -->
            <div class="mb-3">
                <input type="text" class="text-hover mt-1 w-full px-2 py-[1px] border-[2px] border-hover rounded-[3px] placeholder-hover text-center" placeholder="Email">
            </div>

            <!-- Password -->
            <div class="mb-3">
                <input type="password" class="text-hover mt-1 w-full px-2 py-[1px] border-[2px] border-hover rounded-[3px] placeholder-hover text-center" placeholder="Password">
            </div>

            <!-- Upload ID -->
            <div class="mb-4">
                <label for="file-upload" class="cursor-pointer flex flex-col items-center justify-center border-[2px] border-solid border-hover rounded-[3px] h-14">
                    ...
                    <div class="flex items-center">
                        ...
                        <small x-text="fileName ? 'Selected file: ' + fileName : 'Click here to upload'" class="text-hover underline mt-1 block text-center"></small>
                    </div>
                    <input id="file-upload" type="file" class="hidden" @change="fileName = $event.target.files[0].name">
                </label>
            ...
            <!-- Sign Up Button -->
            <div class="flex justify-center gap-12 mt-6">
                <button type="submit" class="bg-hover font-bold text-white px-1 py-1 rounded-[4px] w-[130px] h-[36px] text-[18px]">SIGN UP</button>
                <button type="button" @click="showProfessionalModal = false" class="bg-[#c4eaf7] text-hover text-[18px] h-[36px] font-bold border-hover border-[1px] px-1 py-1 rounded-[4px] w-[130px]">CANCEL</button>
            </div>
        </form>
    </div>
