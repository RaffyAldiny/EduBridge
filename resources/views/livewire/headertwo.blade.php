    ...
    <div x-data="{ isOpen: false, currentPage: window.location.pathname }" class="relative flex items-center justify-between px-8 py-4">
        ...
        <div class="flex items-center justify-center space-x-3">
            ...
            <button class="relative focus:outline-none w-10 h-10 flex items-center justify-center">
                ...
                <span class="absolute -top-1 -right-1 flex items-center justify-center w-5 h-5 bg-red-500 rounded-full text-white text-xs font-bold">
                    {{ $unreadNotifications }}
                </span>
            </button>
            ...
            <a href="{{ route('homepage') }}" class="no-underline">
                <button class="text-maincolor px-4 py-2 hover:bg-yellow-400 hover:border-hover hover:text-hover border-2 text-sm font-bold border-maincolor rounded-lg">
                    L O G O U T
                </button>
            </a>
        </div>
