...
<div x-show="showModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-[#c4eaf7] p-6 rounded-lg shadow-lg w-[400px]">
        ...
        <form x-show="isLogin" class="space-y-1">
            <!-- Username -->
            <div class="mb-[2px]">
                <input type="text" class="mt-1 w-full p-1 border-hover border-[2px] rounded-[4px] text-hover" placeholder="Username">
            </div>

            <!-- Password -->
            <div class="mb-1">
                <input type="password" class=" w-full p-1 border-hover border-[2px] rounded-[4px] text-hover " placeholder="Password">
            </div>

            <!-- Forgot Password (Centered) -->
            <div class="flex justify-center items-center mt-1">
                <a href="#" class="text-sm text-hover mb-3">Forgot your password?</a>
            </div>

            <!-- Login Button -->
            <div class="flex justify-center gap-4 mt-6">
                <button type="submit" class="bg-hover font-bold text-white px-1 py-1  rounded-md w-[130px] h-[36px] text-[18px]">LOGIN</button>
                <button type="button" @click="showModal = false" class="bg-[#c4eaf7] text-hover text-[18px] h-[36px] font-bold border-hover border-[2px] px-1 py-1 rounded-md w-[130px]">CANCEL</button>
            </div>
        </form>
