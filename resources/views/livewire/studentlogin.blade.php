    ...
    <div class="bg-maincolor pt-3 pb-1 pr-6 pl-6 rounded-[6px] shadow-lg w-[400px]">
        ...
        <div class="flex justify-center space-x-8 mb-2 text-[18px]">
            <a href="#" @click="isLogin = true" 
               :class="isLogin ? 'font-bold text-[#0C3A5E] border-b-2 border-[#0C3A5E] pb-1 no-underline transition' : 'text-hover no-underline hover:text-yellow-600'">
               Login
            </a>
        ...
        <form x-show="!isLogin" class="space-y-1">
            ...
            <!-- Upload ID -->
            <div class="mb-4">
                <label for="file-upload-student" class="cursor-pointer flex flex-col items-center justify-center border-[2px] border-solid border-hover rounded-[3px] h-14 hover:bg-yellow-200">
            ...
            <div class="flex justify-center gap-12 mt-6">
                ...
                <button type="button" @click="showStudentModal = false" class="bg-[#c4eaf7] text-hover text-[18px] h-[36px] font-bold hover:bg-yellow-500 hover:border-0 hover:text-maincolor border-hover border-[1px] px-1 py-1 rounded-[4px] w-[130px]">CANCEL</button>
            </div>
        </form>
    </div>
</div>
